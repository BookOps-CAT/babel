...
class TestDataPopulation(unittest.TestCase):
    ...
    def setUp(self):
        with datastore.session_scope() as session:
            datastore_worker.insert_or_ignore(session, datastore.User, name='Tomek', bpl_code='t', nyp_code='k')
            datastore_worker.insert_or_ignore(session, datastore.Vendor, name='China Books', bpl_code='chbks', nyp_code='cbks')
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='world lang', system_id=1, code='wl', includes_audn=True)
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='fiction', system_id=1, code='fc', includes_audn=True)
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='non-fic', system_id=1, code='fn', includes_audn=True)
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='NONE', system_id=1, code=None, includes_audn=False)
            ...
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='world lang', system_id=2, code='0l', includes_audn=True)
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='fiction', system_id=2, code='0f', includes_audn=True)
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='non-fic', system_id=2, code='0n', includes_audn=True)
            datastore_worker.insert_or_ignore(session, datastore.ShelfCode, name='NONE', system_id=2, code=None, includes_audn=False)
