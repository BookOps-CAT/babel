...
if os.name == "posix":
    ...
    def test_mac_paths(mock_mac):
        ...
        assert (
            paths.DEV_LOG_PATH == "/Users/testuser/AppData/Babel/log/dev_babellog.out"
        )
...
if os.name == "nt":
    ...
    def test_windows_paths(mock_windows):
        ...
        assert paths.APP_DATA_DIR == "C:\\Users\\testuser\\AppData\\Local\\Babel"
        assert (
            paths.DEV_LOG_PATH
            == "C:\\Users\\testuser\\AppData\\Local\\Babel\\log\\dev_babellog.out"
        )
        assert (
            paths.PROD_LOG_PATH
            == "C:\\Users\\testuser\\AppData\\Local\\Babel\\log\\babellog.out"
        )
        assert paths.MY_DOCS == "C:\\Users\\testuser\\Documents"
        assert (
            paths.USER_DATA == "C:\\Users\\testuser\\AppData\\Local\\Babel\\user_data"
        )
